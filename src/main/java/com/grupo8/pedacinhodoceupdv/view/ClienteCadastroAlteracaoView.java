...
public class ClienteCadastroAlteracaoView extends javax.swing.JInternalFrame {
        ...
        private void initComponents() {
                ...
                cboEstadoCivil.setModel(new javax.swing.DefaultComboBoxModel(
                                new String[] { " ", "Casado(a)", "Solteiro(a)", "Divorciado(a)", "Viúvo(a)" }));
                ...
                cboEstado.setModel(new javax.swing.DefaultComboBoxModel(
                                new String[] { " ", "AC", "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT",
                                                "MS", "MG", "PA",
                                                "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE",
                                                "TO" }));
                ...
                txtNumero.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
                ...
                try {
                        txtTelefoneCelular.setFormatterFactory(
                                        new javax.swing.text.DefaultFormatterFactory(
                                                        new javax.swing.text.MaskFormatter("(##)#####-####")));
                } catch (java.text.ParseException ex) {
                        ex.printStackTrace();
                ...
                try {
                        txtTelefoneOutros.setFormatterFactory(
                                        new javax.swing.text.DefaultFormatterFactory(
                                                        new javax.swing.text.MaskFormatter("(##)#####-####")));
                } catch (java.text.ParseException ex) {
                        ex.printStackTrace();
                                                                                                ...
                                                                                                .addGroup(layout
                                                                                                                ...
                                                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                                                ...
                                                                                                                                .addGroup(layout.createParallelGroup(
                                                                                                                                                ...
                                                                                                                                                .addComponent(txtTelefoneOutros,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                                140,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE))))
                                                                                                .addGap(0, 0, Short.MAX_VALUE)))));
        ...
        private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSalvarActionPerformed
                ...
                if (clientePreenchido.equalsIgnoreCase("") || clientePreenchido == "") {
                        ...
                        String clienteTamanhoOK = Validacao.ClienteCamposTamanho(txtNome.getText(),
                                        txtCidade.getText(), txtBairro.getText(), txtLogradouro.getText(),
                                        txtNumero.getText(),
                        ...
                        if (clienteTamanhoOK.equalsIgnoreCase("") || clienteTamanhoOK == "") {
                                ...
                                cliente.setTelefoneCelular(
                                                txtTelefoneCelular.getText().replace("(", "").replace(")", "")
                                                                .replace("-", ""));
                                cliente.setTelefoneOutros(
                                                txtTelefoneOutros.getText().replace("(", "").replace(")", "")
                                                                .replace("-", ""));
